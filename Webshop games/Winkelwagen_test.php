    ...
    <div class="container">
      <form action="/action_page.php">
        ...
        <div class="row">
          ...
          <div class="col-50">
            <h3>Betaling</h3>
            <label for="fname">Geaccepteerde kaarten</label>
            ...
            <label for="expmonth">Maand van vervallen</label>
            <input type="text" id="expmonth" name="expmonth" placeholder="September">
            <div class="row">
              <div class="col-50">
                <label for="expyear">Jaar van vervallen</label>
        ...
        <label>
          <input type="checkbox" checked="checked" name="sameadr"> Verzend adres hetzelfde als factuur
        </label>
