...
<body>
    ...
    <div class="Contact">
        <form action="">
            <br>
            <h2>Contact Us</h2>
            <input placeholder="Your Name" class="name" type="text">
            <input placeholder="Your Email" class="email" type="email">
            <input placeholder="Your Message" class="text" type="text"><br>
    ...
    <footer>
        ...
        <div class="footer">
            ...
            <div class="footer_section">
                ...
                <img src="../Img/clock.png" alt="" srcset="">
            ...
            <div class="footer_section2">
                ...
                <li class="active"><a href="../webshop games/producten.php"> Producten </a></li>
                <li><a href="../webshop games/contact.php"> Contact </a></li>
